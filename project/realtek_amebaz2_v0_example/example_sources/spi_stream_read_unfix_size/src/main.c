...
#define SPI0_MOSI                   SPI_MOSI_PIN_SEL2    //PA_19
#define SPI0_MISO                   SPI_MISO_PIN_SEL2    //PA_20
#define SPI0_SCLK                   SPI_SCL_PIN_SEL0     //PA_3
#define SPI0_CS                     SPI_CS_PIN_SEL0      //PA_2
...
void main (void)
{
    ...
    dump_data(TestReceiveBuf, read_length, "SPI Slave Read Data:");
