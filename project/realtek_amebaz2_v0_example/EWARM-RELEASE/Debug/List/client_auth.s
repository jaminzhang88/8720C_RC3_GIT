///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.32.1.169/W32 for ARM        26/Apr/2019  09:01:02
...
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\component\common\ayla\libada\client_auth.c
//    Command line =  
//        -f C:\Users\wyc\AppData\Local\Temp\EWCDA7.tmp
//        ("C:\Users\wyc\Desktop\@@@@@\@9@8720C@8710C@@@@\(1)8720C
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\component\common\ayla\libada\client_auth.c"
...
//    List file    =  
//        C:\Users\wyc\Desktop\@@@@@\@9@8720C@8710C@@@@\(1)8720C
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\project\realtek_amebaz2_v0_example\EWARM-RELEASE\Debug\List\client_auth.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC client_auth_encrypt
        PUBLIC client_auth_gen
...
client_auth_encrypt:
        ...
        MOV      R7,R0
        CMP      R7,R8
        BCC.N    ??client_auth_encrypt_1
        LDR.N    R0,??DataTable4_4
??client_auth_encrypt_0:
        BL       client_log
        B.N      ??client_auth_encrypt_2
??client_auth_encrypt_1:
        MOV      R1,R6
        ...
        MOVS     R5,R0
        BPL.N    ??client_auth_encrypt_3
        MOV      R1,R5
        LDR.N    R0,??DataTable4_7
        BL       client_log
        B.N      ??client_auth_encrypt_2
??client_auth_encrypt_3:
        CMP      R8,R5
        MOV      R2,R5
        BCS.N    ??client_auth_encrypt_4
        MOV      R1,R8
        LDR.N    R0,??DataTable4_8
        BL       client_log
        B.N      ??client_auth_encrypt_2
??client_auth_encrypt_4:
        ADD      R1,SP,#+16
        MOV      R0,R6
        BL       memcpy
??client_auth_encrypt_2:
        ADD      R0,SP,#+8
        BL       mbedtls_pk_free
        MOV      R0,R5
        ADD      SP,SP,#+472
...
??client_auth_gen_0:
        ...
        POP      {R4,R5,PC}       ;; return
??client_auth_gen_1:
        BPL.N    ??client_auth_gen_2
        MOV      R1,R4
        LDR.N    R0,??DataTable4_9
        BL       client_log
        MOV      R0,R4
        B.N      ??client_auth_gen_0
...
?_2:
        ...
        DATA
?_3:
        DC8 "\203auth: pseudo-header too long"
        DATA16
        DC8 0, 0
...
?_5:
        ...
        DATA
?_6:
        DC8 "\203auth: dest length %u insuff need %d"
        DC8 0, 0, 0

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
?_7:
        DC8 "\203auth: base-64 encode failed rc %d"
        DATA8
        DC8 0
