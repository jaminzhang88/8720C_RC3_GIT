...
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\component\common\application\google\google_tls.c
//    Command line =  
//        -f C:\Users\wyc\AppData\Local\Temp\EWB84A.tmp
//        ("C:\Users\wyc\Desktop\@@@@@\@9@8720C@8710C@@@@\(1)8720C
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\component\common\application\google\google_tls.c"
...
//    List file    =  
//        C:\Users\wyc\Desktop\@@@@@\@9@8720C@8710C@@@@\(1)8720C
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\project\realtek_amebaz2_v0_example\EWARM-RELEASE\Debug\List\google_tls.s
//
///////////////////////////////////////////////////////////////////////////////
...
??gn_tls_connect_1:
        ...
        ADDS     R0,R0,#+1
        CMP      R1,#+0
        BGT.N    ??gn_tls_connect_1
        BL       pvPortMalloc
        MOV      R8,R0
        MOV      R2,R5
        ADR.N    R1,??DataTable1  ;; 0x25, 0x64, 0x00, 0x00
        BL       sprintf
        ADD      R5,R4,#+332
        MOVS     R3,#+0
        MOV      R2,R8
...
??gn_tls_connect_2:
        ...
        CBZ.N    R0,??gn_tls_connect_5
        MOV      R1,R0
        LDR.N    R0,??DataTable1_6
        B.N      ??gn_tls_connect_3
??gn_tls_connect_5:
        MOVS     R1,#+0
        MOV      R0,R7
...
gn_tls_read:
        ...
        DATA
?_1:
        DC8 "\012[GOOGLENEST] ERROR: net_connect %d\012"
        DC8 0, 0, 0

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
?_2:
        DC8 "\012[GOOGLENEST] ERROR: ssl_config %d\012"

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
?_3:
        DC8 "\012[GOOGLENEST] ERROR: ssl_setup %d\012"
        DATA8
        DC8 0
        ...
        DATA
?_4:
        DC8 "\012[GOOGLENEST] ERROR: ssl_handshake -0x%x\012"
        DATA16
        DC8 0, 0
        ...
        DATA
?_5:
        DC8 "\012[GOOGLENEST] ERROR: malloc\012"
        DC8 0, 0, 0
