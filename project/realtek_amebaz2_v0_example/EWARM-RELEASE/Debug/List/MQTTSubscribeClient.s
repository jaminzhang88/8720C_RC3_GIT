...
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\component\common\application\mqtt\MQTTPacket\MQTTSubscribeClient.c
//    Command line =  
//        -f C:\Users\wyc\AppData\Local\Temp\EW2C22.tmp
//        ("C:\Users\wyc\Desktop\@@@@@\@9@8720C@8710C@@@@\(1)8720C
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\component\common\application\mqtt\MQTTPacket\MQTTSubscribeClient.c"
...
//    List file    =  
//        C:\Users\wyc\Desktop\@@@@@\@9@8720C@8710C@@@@\(1)8720C
//        sdk-ameba-v7.1a_rc1\sdk-ameba-v7.1a_rc3\project\realtek_amebaz2_v0_example\EWARM-RELEASE\Debug\List\MQTTSubscribeClient.s
//
///////////////////////////////////////////////////////////////////////////////
...
MQTTSerialize_subscribe:
        ...
        IT       LT 
        MVNLT    R0,#+1
        BLT.N    ??MQTTSerialize_subscribe_0
        STRB     R5,[SP, #+4]
        LDR      R1,[SP, #+4]
        LSLS     R6,R6,#+3
        AND      R6,R6,#0x8
...
??MQTTSerialize_subscribe_1:
        CMP      R5,R4
        BLT.N    ??MQTTSerialize_subscribe_2
        LDR      R0,[SP, #+0]
        SUBS     R0,R0,R7
...
MQTTDeserialize_suback:
        ...
        SUBS     R1,R7,R1
        CMP      R1,#+1
        BLE.N    ??MQTTDeserialize_suback_0
        MOV      R0,SP
        BL       readInt
        STRH     R0,[R4, #+0]
        MOVS     R0,#+0
...
??MQTTDeserialize_suback_1:
        ...
        LDR      R4,[R6, #+0]
        CMP      R8,R4
        BGE.N    ??MQTTDeserialize_suback_2
        MOV      R5,#-1
