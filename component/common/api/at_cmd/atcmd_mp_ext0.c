...
//#error//add relative file and macro here for AmebaD
...
#define GNT_BT_USAGE		"ATM0=gnt_bt,TARGET <TARGET: wlan/bt>\n"
#define CLK_SOURCE_USAGE	"ATM0=clk_source,TARGET <TARGET: bb/pll>\n"
...
static int mp_ext0_gnt_bt(void **argv, int argc)
{
	if(strcmp(argv[0], "wlan" ) == 0){
		GNT_BT_to_wifi();
		MP_EXT0_PRINTF("Switch GNT_BT to WLAN.\n\r");
		
	}else if(strcmp(argv[0], "bt" ) == 0){
		GNT_BT_to_bt();
		MP_EXT0_PRINTF("Switch GNT_BT to BT.\n\r");
	}
	return 0;
}

static int mp_ext0_clk_source(void **argv, int argc)
{		
	if(strcmp(argv[0], "bb" ) == 0){
		// 0x54[19]=0 , 0x880[3:2]=01 , 0x880[18]=1
		HAL_WRITE32(0x40080000, 0x54, (HAL_READ32(0x40080000, 0x54) & (~BIT19)));
		HAL_WRITE32(0x40080000, 0x880, (HAL_READ32(0x40080000, 0x880) & (~BIT3)) | (BIT18| BIT2)) ;
		MP_EXT0_PRINTF("Set clk source to BB.\n\r");
	}else if(strcmp(argv[0], "pll" ) == 0){
		// 0x54[19]=1 , 0x880[3:2]=00 , 0x880[18]=0
		HAL_WRITE32(0x40080000, 0x54, HAL_READ32(0x40080000, 0x54) | (BIT19));
		HAL_WRITE32(0x40080000, 0x880, HAL_READ32(0x40080000, 0x880) & (~(BIT3 | BIT2 | BIT18)));		
		MP_EXT0_PRINTF("Set clk source to PLL.\n\r");
	}
	return 0;
}
...
at_mp_ext_item_t at_mp_ext0_items[] = {
	...
	{"gnt_bt",		mp_ext0_gnt_bt,				GNT_BT_USAGE},
	{"clk_source",	mp_ext0_clk_source,			CLK_SOURCE_USAGE},
...
#endif 	// #if CONFIG_PLATFORM_8710C || CONFIG_PLATFORM_8721D
